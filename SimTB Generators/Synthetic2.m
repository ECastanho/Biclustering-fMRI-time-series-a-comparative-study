...
%
% ------------------
% In this case, the only change to the original file is related with the out_path (changed)
% and the number of subjects parameter (M), changed to 1 (I only want to generate 1 person)
% --------------------
%
%
% To lanch the simulator 
% >> simtb
% 
% To create the simulation parameter structure:
% >> sP = simtb_create_sP('Simulation2_generator');
% 
